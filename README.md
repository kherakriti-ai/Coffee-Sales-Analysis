...
Using Python in Google Colab, I explored customer behavior, product trends, and sales patterns.  
I then integrated the findings into a Dify-powered chatbot, allowing users to query insights in natural language.
...
- **Temperature and time of day strongly influence product choice**  
- **Most transactions are small (1–2 items)**, highlighting an opportunity to increase average order value  
- **25–34 age group contributes the highest sales volume**
...
- What drives coffee shop sales?
- How do loyal customers behave?
